...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect will happen automatically via App.tsx when user is authenticated
    } catch (err: any) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Horizon IBMS</h1>
            <p className="text-gray-600">Investment & Business Management</p>
          </div>
        ...
        <div className="text-center mt-6 text-white text-sm">
          <p>&copy; 2024 Horizon IBMS. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
